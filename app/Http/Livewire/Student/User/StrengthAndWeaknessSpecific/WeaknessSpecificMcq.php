...
class WeaknessSpecificMcq extends Component
{
    ...
    public function overall()
    {
        ...
        foreach ($specificTags as $key => $specificTag) {
            ...
            if ($this->percent <= 60) {
                $this->weakness = $this->questionContentTag->title;
            }
        }
    }
    ...
    {
        return view('livewire.student.user.strength-and-weakness-specific.weakness-specific-mcq');
    }
}
