    ...
    public function batchTest(CourseTopic $course_topic, Batch $batch, $exam_id, $exam_type){
        ...
        if ($exam_type == Edvanture::APTITUDETEST) {
                ...
                if ( !$canAttempt ) {
                    ...
                    return view('student.pages_new.batch.exam.batch_exam_aptitude_test', compact('mcq_questions', 'exam', 'batch','course_topic'));
        ...
        if ($exam_type == Edvanture::TOPICENDEXAM) {
            ...
            if(!$mcq_exam_result && !$cq_exam_result){
                ...
                if (!$canAttempt) {
                    ...
                    return view('student.pages_new.batch.exam.batch_exam_cq_plus_mcq', compact('mcq_questions', 'cq_questions', 'exam', 'batch','course_topic'));
                }
            }
        }
