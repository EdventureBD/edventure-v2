<x-landing-layout headerBg="white">
    ...
    {{-- custom css link  --}}
    <link rel="stylesheet" href="/css/bundle-detail.css">
    ...
    <div class="container">
        ...
        <div class="d-flex mb-3" id="parent-div">
            <div class="w-100  mt-5">
                <h2 class="bold-header" id="bundle-title-1">
                    {{ $bundle->bundle_name }}
                </h2>
                        ...
                        <div class="col-md-6 d-flex my-2">
                            ...
                            <div class="col-8 d-flex flex-column p-0 my-auto">
                                ...
                                <div class="text-nowrap detail-parts-font">
                                    {{\App\Enum\Converter::en2bn($bundle->totalBundleEnrolled()).' জন'}}
                                </div>
                            </div>
                        </div>
                        ...
                        @if($bundle->time_allotted)
                            <div class="col-md-6 d-flex my-2">
                                ...
                                <div class="col-8 d-flex flex-column p-0 my-auto">
                                    ...
                                    <div class="text-nowrap detail-parts-font">
                                        {{\App\Enum\Converter::en2bn($bundle->time_allotted) ?? 0}} ঘন্টা
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        @if($bundle->video_lecture)
                            <div class="col-md-6 d-flex my-2">
                                ...
                                <div class="col-8 d-flex flex-column p-0 my-auto">
                                    ...
                                    <div class="text-nowrap detail-parts-font">
                                        {{\App\Enum\Converter::en2bn($bundle->video_lecture) ?? 0}}
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        @if($bundle->given_notes)
                            <div class="col-md-6 d-flex my-2">
                                ...
                                <div class="col-8 d-flex flex-column p-0 my-auto">
                                    ...
                                    <div class="text-nowrap detail-parts-font">
                                        {{\App\Enum\Converter::en2bn($bundle->given_notes) ?? 0}}
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        @if($bundle->quiz)
                            <div class="col-md-6 d-flex my-2">
                                ...
                                <div class="col-8 d-flex flex-column p-0 my-auto">
                                    ...
                                    <div class="text-nowrap detail-parts-font">
                                        {{\App\Enum\Converter::en2bn($bundle->quiz) ?? 0}} টি
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        @if($bundle->mind_map)
                            <div class="col-md-6 d-flex my-2">
                                ...
                                <div class="col-8 d-flex flex-column p-0 my-auto">
                                    ...
                                    <div class="text-nowrap detail-parts-font">
                                        {{\App\Enum\Converter::en2bn($bundle->mind_map) ?? 0}}
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="d-flex overflow-x-scroll"
                             ...
                             @foreach($teachers as $teacher)
                                <div class="teachers-parent text-center {{count($teachers) == 1 ? 'col-12' : 'col-6'}} d-flex flex-column justify-content-center align-items-center">
                                    @if($teacher->image)
                                        <img style="border-radius: 50%" height="80" width="80" src="{{$teacher->image}}" alt="" class="teachers-image">
                                    @else
            ...
            <div class="w-100 ml-lg-5 mt-5">
                <h2 class="bold-header d-none" id="bundle-title-2">
                    {{ $bundle->bundle_name }}
                </h2>
                <div class="test">
                    <iframe
