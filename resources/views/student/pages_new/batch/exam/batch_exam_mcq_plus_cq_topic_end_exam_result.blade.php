                     ...
                     <tbody>
                        ...
                        @foreach ($mcq_details_results as $key => $mcq_details_result)
                           <tr>
                              ...
                              <td class="br-purple2">{!! $mcq_details_result->topicEndExamMCQ->question !!}</td>
                              <td class="br-purple2">{{ $mcq_details_result->mcq_ans }}</td>
                              <td class="br-purple2">{!! $mcq_details_result->topicEndExamMCQ->answer !!}</td>
                              <td class="br-purple2">{{ $mcq_details_result->topicEndExamMCQ->explanation }}</td>
