            ...
            <div class="container">
                  <div class="py-5" style="display: flex; flex-direction: column;">
                     ...
                     <div class="d-flex mx-auto">
                        <a href="{{ route('batch-lecture', ['batch' => $batch->slug]) }}" class="btn text-xxsm text-white bg-purple px-3 py-2 mt-3 mx-1"> Go Back to Journey <i class="fas fa-arrow-up ml-2"></i></a>
