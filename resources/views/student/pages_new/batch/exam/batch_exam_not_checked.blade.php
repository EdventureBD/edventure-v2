         ...
         <div class="" style="background: #75E9AA !important;">
            <div class="container">
                  <div class="py-5" style="display: flex; flex-direction: column;">
                     <h1 class="display-5 text-sm text-purple max-w-38 mx-auto fw-600" style="text-align: center">You have successfully attempted this exam. However, it is still yet to be checked. Visit later to see your results.</h1>
