                ...
                <div class="container page__container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 text-lg-right d-flex flex-lg-column mb-24pt mb-lg-0 border-bottom border-lg-0 pb-16pt pb-lg-0">
                            ...
                            <div>
                                <a href="{{ route('getInvoice', [$course, $payments]) }}" class="btn btn-accent">
                ...
                <div class="px-16pt">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body text-50">
                            Admin will check your payment information. If everything is okay {{ config('app.name') }} will contact with you.
                        </div>
                    </div>
                </div>
            </div>
