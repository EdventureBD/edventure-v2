...
@section('content')
    ...
    <div class="mdk-header-layout__content page-content ">
        <div class="page-section bg-info" data-block-id="pricing-cards">
            <div class="container page__container">
                <div class="hero text-center pb-64pt">
                    <h1 class="text-white">Enroll this course</h1>
                    <p class="text-white-100 lead measure-hero-lead mx-auto">Enroll this course by chosing one of the bellow
                        plan. </p>
                </div>
                <div class="row card-group-row mb-16pt mb-lg-40pt">
                    <div class="col-lg-6 col-sm-6 card-group-row__col">
                        <div class="card card-group-row__card text-center o-hidden card--raised border-0">
                            <span
                                class="corner-ribbon corner-ribbon--default-right-top corner-ribbon--shadow bg-accent text-white">Start</span>
                            <div class="card-body d-flex flex-column">
                                <div class="flex-grow mb-16pt">
                                    <span
                                        class="w-64 h-64 icon-holder icon-holder--outline-accent rounded-circle d-inline-flex mb-16pt">
                                        <i class="material-icons">filter_1</i>
                                    </span>
                                    <h4 class="mb-8pt">Monthly</h4>
                                    <p class="text-70 mb-0">Access the course monthly.</p>
                                </div>
                                <p class="d-flex justify-content-center align-items-center m-0">
                                    ...
                                    <span class="h1 m-0 font-weight-normal">
                                        @php
                                            echo round($course->price / $course->duration);
                                        @endphp
                                    </span>
                            ...
                            <div class="card-footer">
                                <a href="{{ route('confirm', $course->slug) }}" class="btn btn-accent">Enroll</a>
                            </div>
                        </div>
                        ...
                        <div class="card card-group-row__card text-center o-hidden border-0">
                            <div class="card-body d-flex flex-column">
                                <div class="flex-grow mb-16pt">
                                    ...
                                    <h4 class="mb-8pt">Full Course</h4>
                                    <p class="text-70 mb-0">Access the full course.</p>
                                </div>
                                <p class="d-flex justify-content-center align-items-center m-0">
                                    <span class="h4 m-0 font-weight-normal">&#2547;</span>
                                    <span class="h1 m-0 font-weight-normal">{{ $course->price }}</span>
                                    <span class="h4 m-0 font-weight-normal">&#8658; {{ $course->duration }} month</span>
                                </p>
                            </div>
                            <div class="card-footer">
                                <a href="signup.html" class="btn btn-outline-secondary">Enroll</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-group-row__card text-center o-hidden border-0">
                            ...
                            <div class="card-body d-flex flex-column">
                                <div class="flex-grow mb-16pt">
                                    ...
                                    <p class="text-70 mb-0">Build customized learning paths with content that aligns to your
                                        internal learning goals.</p>
                                </div>
                                <p class="d-flex justify-content-center align-items-center m-0">
                    ...
                    <div class="row">
                        <div class="col-sm-6 mb-24pt mb-sm-0">
                            <ul class="list-unstyled">
                                ...
                                <li class="d-flex align-items-center mb-8pt">
                                    <span class="text-white-20 material-icons mr-8pt">check</span>
                                    <span class="text-white-70">Access to New Videos Weekly</span>
                                </li>
                                <li class="d-flex align-items-center mb-8pt">
                                    <span class="text-white-20 material-icons mr-8pt">check</span>
        ...
        {{-- <div class="page-section border-bottom-2" data-block-id="feedback-carousel">
            <div class="container page__container">
                <div class="page-headline text-center">
                    <h2>Feedback</h2>
                    <p class="lead measure-lead mx-auto text-70">What other students turned professionals have to say about
                        us after learning with us and reaching their goals.</p>
                </div>
        ...
        <div class="border-top-1 page-section" data-block-id="faq">
            <div class="container page__container">
                <div class="page-headline text-center">
                    <h2>FAQ</h2>
                    ...
                    <div class="col-md-6 card-group-row__col">
                        ...
                        <div class="card card--elevated card-group-row__card">
                            <div class="card-body d-flex">
                                ...
                                <div class="flex">
                                    <a class="card-title mb-8pt" href="">Do you offer a free trial?</a>
                                    <p class="text-70 mb-0">We offer everyone a 7 day free trial! You can take advantage of
                                        it by visiting our sign-up page! Lorem ipsum dolor sit amet, consectetur adipisicing
                                        elit. Porro, ab!</p>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 card-group-row__col">
                        ...
                        <div class="card card--elevated card-group-row__card">
                            <div class="card-body d-flex">
                                ...
                                <div class="flex">
                                    <a class="card-title mb-8pt" href="">Can I gift a subscription to someone?</a>
                                    <p class="text-70 mb-0">Yes! We do offer certificates. Please email us for more
                                        information. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos, ad!</p>
                                </div>
                            </div>
                            <div class="card-footer d-flex lh-1 px-16pt py-8pt">
                                <div class="flex text-muted"><small>7 people found this useful</small></div>
                    ...
                    <div class="col-md-6 card-group-row__col">
                        ...
                        <div class="card card--elevated card-group-row__card">
                            <div class="card-body d-flex">
                                ...
                                <div class="flex">
                                    <a class="card-title mb-8pt" href="">I have a great idea for an application or website,
                                        but need help on where to begin. Can you guys help me?</a>
                                    <p class="text-70 mb-0">We advise posting personal requests in our Community Forum Lorem
                    ...
                    <div class="col-md-6 card-group-row__col">
                        ...
                        <div class="card card--elevated card-group-row__card">
                            <div class="card-body d-flex">
                                ...
                                <div class="flex">
                                    <a class="card-title mb-8pt" href="">I found a bug. Where can I report that?</a>
                                    <p class="text-70 mb-0">In the unlikely situation you stumble across a bug, go ahead and
                                        shoot us an email. Lorem ipsum dolor sit amet.</p>
                                </div>
                            </div>
                            <div class="card-footer d-flex lh-1 px-16pt py-8pt">
                                <div class="flex text-muted"><small>7 people found this useful</small></div>
