    ...
    <section class="" style="position:relative">
        ...
        <div class="mt-0" id="text-in-landing">
            ...
            <div id="landing_greeting_and_register_button">
                ...
                <div>
                    <a href="{{route('register')}}" class="font-roboto text-xsm btn btn-register px-md-4 my-md-4 py-md-3" style="background: #6400c8; border: 1px solid #6400c8">REGISTER NOW</a>
                </div>
            </div>
            @endauth
