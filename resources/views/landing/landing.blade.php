            ...
            <div class="row">
                <div class="col-md-5 col-sm-6 py-md-5">
                    <div class="pl-3">
                        ...
                        <a href="{{route('medi-olympiad')}}" class="font-roboto border-none text-xxsm btn btn-register text-white bg-gradient-purple px-4">Jump to Olympiad <i class="fa fa-arrow-right icon"></i></a>
                        @else
                        <div id="landing_greeting_and_register_button">
                            <div>
