                <li class="nav-item has-treeview {{ request()->is('admin/batch')? 'menu-open': '' }} 
                                                ...
                                                ">
                    <a href="#" class="nav-link {{ request()->is('admin/batch')? 'active': '' }} 
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('batch.index') }}" class="nav-link {{ request()->is('admin/batch/create')? 'active': '' }} {{ request()->is('admin/batch')? 'active': '' }} {{ request()->is('admin/batch/*/edit')? 'active': '' }} {{ request()->is('admin/batch/*')? 'active': '' }} ">
                                <i class="fab fa-bootstrap"></i>                                
                                <p>&nbsp; Batches </p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('batch-lecture.index') }}" class="nav-link {{ request()->is('admin/batch-lecture')? 'active': '' }} {{ request()->is('admin/batch-lecture/create')? 'active': '' }} {{ request()->is('admin/batch-lecture/*/edit')? 'active': '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('batch-exam.index') }}" class="nav-link {{ request()->is('admin/batch-exam')? 'active': '' }} 
                                                                                    {{ request()->is('admin/batch-exam/create')? 'active': '' }} 
                                                                                    {{ request()->is('admin/batch-exam/*/edit')? 'active': '' }} 
                                                                                    {{ request()->is('admin/batch-exam/*')? 'active': '' }} 
                                                                                    ">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('live-class.index') }}" class="nav-link {{ request()->is('admin/live-class')? 'active': '' }} {{ request()->is('admin/live-class/create')? 'active': '' }} {{ request()->is('admin/live-class/*/edit')? 'active': '' }}">
