            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('course')
                    <li
                        ...
                        {{ request()->is('admin/course-category') ? 'menu-open' : '' }} {{ request()->is('admin/course-category/create') ? 'menu-open' : '' }}  {{ request()->is('admin/course-category/*') ? 'menu-open' : '' }}
                        {{ request()->is('admin/intermediary_level') ? 'menu-open': '' }} {{ request()->is('admin/intermediary_level/create') ? 'menu-open': '' }} {{ request()->is('admin/intermediary_level/*/edit') ? 'menu-open': '' }}
                        {{ request()->is('admin/bundle') ? 'menu-open' : '' }} {{ request()->is('admin/bundle/create') ? 'menu-open' : '' }}  {{ request()->is('admin/bundle/*') ? 'menu-open' : '' }}
                        {{ request()->is('admin/course')? 'menu-open': '' }} {{ request()->is('admin/course/*')? 'menu-open': '' }} {{ request()->is('admin/course/*/edit')? 'menu-open': '' }}
                        {{ request()->is('admin/batch/create') ? 'menu-open' : '' }} {{ request()->is('admin/batch') ? 'menu-open' : '' }} {{ request()->is('admin/batch/*/edit') ? 'menu-open' : '' }} {{ request()->is('admin/batch/*') ? 'menu-open' : '' }}
                        {{ request()->is('admin/course-topic')? 'menu-open': '' }} {{ request()->is('admin/course-topic/menu-open')? 'menu-open': '' }} {{ request()->is('admin/course-topic/*/edit')? 'menu-open': '' }}
                        {{ request()->is('admin/batch-lecture') ? 'menu-open' : '' }} {{ request()->is('admin/batch-lecture/create') ? 'menu-open' : '' }} {{ request()->is('admin/batch-lecture/*/edit') ? 'menu-open' : '' }}
                        {{ request()->is('admin/content-tag') ? 'menu-open' : '' }} {{ request()->is('admin/content-tag/create') ? 'menu-open' : '' }} {{ request()->is('admin/content-tag/*/edit') ? 'menu-open' : '' }}
                        {{ request()->is('admin/batch-exam') ? 'menu-open' : '' }} {{ request()->is('admin/batch-exam/create') ? 'menu-open' : '' }} {{ request()->is('admin/batch-exam/*/edit') ? 'menu-open' : '' }} {{ request()->is('admin/batch-exam/*') ? 'menu-open' : '' }}
                        {{ request()->is('admin/course-lecture')? 'menu-open': '' }} {{ request()->is('admin/course-lecture/create')? 'menu-open': '' }} {{ request()->is('admin/course-lecture/*/edit')? 'menu-open': '' }} {{ request()->is('admin/course-lecture/*')? 'menu-open': '' }}

                        {{-- Submenu menu-open --}}
                        {{ request()->is('admin/exam') ? 'menu-open' : '' }} {{ request()->is('admin/exam/create') ? 'menu-open' : '' }} {{ request()->is('admin/exam/*/edit') ? 'menu-open' : '' }} {{ request()->is('admin/exam/*') ? 'menu-open' : '' }}
