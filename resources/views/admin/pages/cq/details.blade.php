            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12 order-2 order-md-1">
                            ...
                            <div class="col-md-2">
                                <div class="info-box bg-light">
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number text-center text-muted mb-0">{{ $cq->marks }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="info-box bg-light">
                                    <div class="info-box-content">
                                        <span class="info-box-text text-center text-muted">Number of attended
                                            participants</span>
                                        <span
                                            class="info-box-number text-center text-muted mb-0">{{ $cq->number_of_attempt }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-4">
                                <div class="info-box bg-light">
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number text-center text-muted mb-0">{{ $cq->gain_marks }}
                                            <span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-4">
                                <div class="info-box bg-light">
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number text-center text-muted mb-0">{{ $cq->success_rate }}
                                            <span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="/Viewer.js/#..{{ Storage::url($cq->standard_ans_pdf) }}">
                            </div>
                        </div>
                    </div>
                </div>
