                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                {{-- <input type="text" class="form-control" value="{{ $aptitude_test_mcq->question }}"
                                                    disabled> --}}
                                                <p>{!! $aptitude_test_mcq->question !!}</p>
                                                @error('question')
                                                ...
                                                <div class="input-group">
                                                    <div class="___class_+?18___">
                                                        <img class="product-image-thumb"
                                                            src='{{ $aptitude_test_mcq->image }}' alt="">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" disabled>
                                                    <option @if ($aptitude_test_mcq->answer == 1) selected @endif>Option 1</option>
                                                    <option @if ($aptitude_test_mcq->answer == 2) selected @endif>Option 2</option>
                                                    <option @if ($aptitude_test_mcq->answer == 3) selected @endif>Option 3</option>
                                                    <option @if ($aptitude_test_mcq->answer == 4) selected @endif>Option 4</option>
                                                </select>
                                                @error('answer')
                                                    <p style="color: red;">{{ $message }}</p>
                                                @enderror
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" disabled
                                                    value="{{ $aptitude_test_mcq->number_of_attempt }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" disabled
                                                    value="{{ $aptitude_test_mcq->gain_marks }}">
                                                @error('gain_marks')
                                                    <p style="color: red;">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" disabled
                                                    value="{{ $aptitude_test_mcq->success_rate }}">
                                                @error('success_rate')
                                                    <p style="color: red;">{{ $message }}</p>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 card">
                                            <div class="form-group card-body">
                                                ...
                                                <p>{!! $aptitude_test_mcq->explanation !!}</p>
                                            </div>
                                        </div>
                                    </div>
