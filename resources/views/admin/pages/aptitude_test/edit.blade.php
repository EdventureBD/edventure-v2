            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-warning">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form role="form" method="POST" action="{{ route('aptitude-test-mcqs.update', [$exam, $aptitude_test_mcq]) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    {{-- <input type="text" class="form-control" name="question"
                                                value={{ $aptitude_test_mcq->question }} placeholder="Enter question"> --}}
                                    <textarea input="question" id="question" name="question" placeholder="Enter question"
                                        style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('question') ? old('question') : $aptitude_test_mcq->question }}</textarea>
                                    @error('question')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            @if ($aptitude_test_mcq->image)
                                                <img class="product-image" src="{{ $aptitude_test_mcq->image}}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {{-- <input type="text" class="form-control" name="field1"
                                                value="{{ $aptitude_test_mcq->field1 }}" placeholder="Option 1"> --}}
                                            <textarea input="field1" id="field1" name="field1" placeholder="Option 1"
                                                style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('field1') ? old('field1') : $aptitude_test_mcq->field1 }}</textarea>
                                            @error('field1')
                                                <p style="color: red;">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {{-- <input type="text" class="form-control" name="field2"
                                                value="{{ $aptitude_test_mcq->field2 }}" placeholder="Option 2"> --}}
                                            <textarea input="field2" id="field2" name="field2" placeholder="Option 2"
                                                style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('field2') ? old('field2') : $aptitude_test_mcq->field2 }}</textarea>
                                            @error('field2')
                                                <p style="color: red;">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {{-- <input type="text" class="form-control" name="field3"
                                                value="{{ $aptitude_test_mcq->field3 }}" placeholder="Option 3"> --}}
                                            <textarea input="field3" id="field3" name="field3" placeholder="Option 3"
                                                style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('field3') ? old('field3') : $aptitude_test_mcq->field3 }}</textarea>
                                            @error('field3')
                                                <p style="color: red;">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {{-- <input type="text" class="form-control" name="field4"
                                                value="{{ $aptitude_test_mcq->field4 }}" placeholder="Option 4"> --}}
                                            <textarea input="field4" id="field4" name="field4" placeholder="Option 4"
                                                style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('field4') ? old('field4') : $aptitude_test_mcq->field4 }}</textarea>
                                            @error('field4')
                                                <p style="color: red;">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="answer">
                                                ...
                                                <option value="1" {{ $aptitude_test_mcq->answer == 1 ? 'selected' : '' }}>Option 1</option>
                                                <option value="2" {{ $aptitude_test_mcq->answer == 2 ? 'selected' : '' }}>Option 2</option>
                                                <option value="3" {{ $aptitude_test_mcq->answer == 3 ? 'selected' : '' }}>Option 3</option>
                                                <option value="4" {{ $aptitude_test_mcq->answer == 4 ? 'selected' : '' }}>Option 4</option>
                                            </select>
                                            @error('answer')
                                                <p style="color: red;">{{ $message }}</p>
                                            @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea input="explanation" id="explanation" name="explanation"
                                        ...
                                        style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('explanation') ? old('explanation') : $aptitude_test_mcq->explanation }}</textarea>
                                    @error('explanation')
                                        <p style="color: red;">{{ $message }}</p>
                                    @enderror
                                </div>
