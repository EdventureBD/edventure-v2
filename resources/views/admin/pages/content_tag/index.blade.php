                                ...
                                <div class="input-group input-group-sm">
                                    <div>
                                        <a href="{{ route('tagEmptyExportCSV') }}">
                                            <button class="btn btn-info"><i class="fas fa-download"></i></i>&nbsp;&nbsp; Sample input CSV</button>
                                        </a>
                                        <a href="{{ route('contentTagExportCSV') }}">
                                            <button class="btn btn-info"><i class="fas fa-download"></i>&nbsp;&nbsp; Export content tags</button>
                                        </a>
                                        ...
                                        <div class="modal fade" id="modal-default">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('contentTagImportCSV') }}" method="POST" enctype="multipart/form-data">
                                                        {{ csrf_field() }}
                                        ...
                                        <a href="{{ route('content-tag.create') }}">
                                            <button class="btn btn-info"><i class="fas fa-plus-square"></i>&nbsp;&nbsp; Content Tag</button>
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    @foreach($content_tags as $content_tag)
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" class="customControlInput" id="single-col-{{ $content_tag->id }}" data-id="{{ $content_tag->id }}" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" {{ $content_tag->status ? 'checked' : '' }} >
                                            </td>
                                            <td>
                                                <div class="btn-group">
                                                    <a class="mr-1" href="{{ route('content-tag.edit', $content_tag->slug) }}" title="Edit {{ $content_tag->title }}">
                                                        <button class="btn btn-info"><i class="far fa-edit"></i></button>
                                                    </a>
                                                    <a class="mr-1" href="#deleteContentTag{{ $content_tag->id }}" data-toggle="modal" title="Delete {{ $content_tag->title }}">
                                                        <button class="btn btn-danger"><i class="far fa-trash-alt"></i></button>
                                                    </a>
                                                    <div class="modal fade" id="deleteContentTag{{ $content_tag->id }}">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content bg-danger">
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">Delete {{ $content_tag->title }} content tag</h4>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                                </div>
                                                                ...
                                                                <div class="modal-footer justify-content-between">
                                                                    ...
                                                                    <form action="{{ route('content-tag.destroy', $content_tag->slug) }}" method="POST">
                                                                        @csrf
                                                                        @method('delete')
