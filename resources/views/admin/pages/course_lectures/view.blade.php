                      ...
                      <div class="card-body">
                              <div class="form-group">
                                  ...
                                  <input disabled type="text" wire:model="title"
                                      ...
                                      id="courseTitle" value="{{$courseLecture->title}} ">
                                  @error('title')
                                ...
                                <label class="col-form-label" for="courseurl">Lecture Video </label> <br>
                                  <div class="form-group container">
                                    @if ($courseLecture->url)
                                        <iframe src="https://player.vimeo.com/video/{{ $courseLecture->url }}" width="640" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                                    @endif
                                  </div>
                              </div>
