                                ...
                                <div class="input-group input-group-sm">
                                    <div>
                                        <a href="{{ route('courseCSV') }}">
                                            <button class="btn btn-info"><i class="fas fa-download"></i>&nbsp;&nbsp;Export Courses</button>
                                        </a>
                                        <a href="{{ route('course.create') }}">
                                            <button class="btn btn-info"><i class="fas fa-plus-square"></i>&nbsp;&nbsp;Course</button>
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    @foreach($courses as $course)
                                        <tr>
                                            ...
                                            <td><iframe src="https://player.vimeo.com/video/{{ $course->trailer}}" width="100" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe></td>
