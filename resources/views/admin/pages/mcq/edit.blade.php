            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-warning">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form role="form" method="POST" action="{{ route('mcq.update', $mcq) }}" enctype="multipart/form-data">
                                @method('PUT')
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="question" value={{ $mcq->question }} placeholder="Enter question">
                                            @error('question')
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="field1" value="{{ $mcq->field1 }}" placeholder="Option 1">
                                            @error('field1')
                                                <p style="color: red;">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="field2" value="{{ $mcq->field2 }}" placeholder="Option 2">
                                            @error('field2')
                                                <p style="color: red;">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="field3" value="{{ $mcq->field3 }}" placeholder="Option 3">
                                            @error('field3')
                                                <p style="color: red;">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="field4" value="{{ $mcq->field4 }}" placeholder="Option 4">
                                            @error('field4')
                                                <p style="color: red;">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="select2-purple">
                                            <select class="select2" multiple name="contentTagIds[]" data-placeholder="Select a Content Tag" data-dropdown-css-class="select2-purple" style="width: 100%;">
                                                @foreach ($questionContentTags as $questionContentTag)
                                                    <option value="{{ $questionContentTag->content_tag_id }}" selected>{{ $questionContentTag->contentTag->title }}</option>
                                                @endforeach
