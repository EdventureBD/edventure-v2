...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 09, 2022 at 02:55 PM
...
--
ALTER TABLE `aptitude_test_mcqs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3529;
...
--
ALTER TABLE `question_content_tags`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8959;
